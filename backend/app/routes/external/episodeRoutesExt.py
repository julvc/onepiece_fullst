...
@router.get("/en/count/saga/{saga_id}",response_model=List[Episode] ,summary="Get count episodes by saga")
...
@router.get("/en/count/saga/{arc_id}",response_model=List[Episode] ,summary="Get count episodes by saga")
...
@router.get("/en/search",response_model=List[Episode] ,summary="Search episode by saga")
...
@router.get("/en/saga/{arc_id}", summary="Get episodes by saga ID")
